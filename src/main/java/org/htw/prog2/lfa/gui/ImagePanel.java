...
public class ImagePanel extends JPanel {
    ...
    public int[] reformCoordsTop(int[] coords){
        int y0a = coords[1];
    ...
    public int[] reformCoordsBot(int[] coords){
        int y1u = coords[3];
    ...
    public void paintComponent(Graphics g) {
        ...
        if(img == null && config == null){
            ...
            g.drawString("N/A",((imagePanel.getWidth()/2)+6),getHeight()/2);
        }else if(img != null && config == null){
            g.drawImage(img.getImage(),x,y,31,78,this);
        }else if(config != null && img == null){
